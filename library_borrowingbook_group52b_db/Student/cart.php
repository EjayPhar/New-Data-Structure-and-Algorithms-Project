...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['checkout'])) {
    ...
    if (count($cart_items) > 0) {
        foreach ($cart_items as $item) {
            ...
            if ($book) {
                // Insert into borrowings with borrow_date as today and due_date as 7 days from today
                $borrow_sql = "INSERT INTO borrowings (user_id, book_id, borrow_date, due_date, status) 
