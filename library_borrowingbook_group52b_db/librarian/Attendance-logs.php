...
if (!isset($_SESSION['user_id']) || !in_array($_SESSION['role'], ['staff', 'student'])) {
...
<body class="font-display bg-background-light dark:bg-background-dark text-slate-700 dark:text-slate-300">
    <div class="flex h-screen">
        ...
        <div class="flex-1 flex flex-col">
            <header
                ...
                <h1 class="text-xl font-semibold text-slate-800 dark:text-slate-100"><?php echo $is_student ? 'Student Dashboard' : 'Librarian Dashboard'; ?></h1>
    ...
    <script>
        // this is a Sidebar toggle for small screens (show/hide with backdrop)
        (function () {
        ...
        // this is Attendance period toggle
        (function () {
